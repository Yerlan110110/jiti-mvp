...
router.post('/driver-online', roleMiddleware('driver'), (req, res, next) => orderController.setDriverOnline(req, res, next));
...
router.post('/:id/accept', roleMiddleware('driver'), (req, res, next) => orderController.accept(req, res, next));
